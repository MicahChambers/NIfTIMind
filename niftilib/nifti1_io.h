...
/********************** MiND Data Structures **************************/
typedef enum _mind_codes {
  MIND_NONE = 0,
  MIND_RAWDWI = 1,
  MIND_DTENSOR = 2,
  MIND_DISCSPHFUNC = 3,
  MIND_REALSPHARMCOEFFS = 4
} NiftiMindCode;
...
typedef union {
	char data[16];
	NiftiRawDWI diff_dir;
	NiftiTensorPos tensor_index;
	NiftiMeshPoint sph_point;
	NiftiSphereHarmonic sph_order;
} NiftiMindExt; 
